...
const FLOOR_MESSAGES: Record<TextFloorReason, string> = {
  "malformed-props": "This blog idea cannot be drawn: the view was opened without anything to show.",
  "props-version": "This blog idea cannot be drawn: it was handed a view of a version this display does not read.",
  "channel-version": "This blog idea cannot be drawn: its content arrived in a form of the content channel this display does not read.",
  "content-unavailable": "This blog idea cannot be drawn here: this view was not given the text to show.",
  "content-absent": "No text is available to show for the revision being viewed.",
  "content-over-cap": "This blog idea is too large to show here. Download it to read the whole of it.",
  ...
  "content-revision-mismatch": "This blog idea cannot be drawn: the text handed to this view was read from a different revision than the one being viewed.",
  "invalid-content-projection": "This blog idea cannot be drawn: the content handed to this view is incomplete.",
  "empty-document": "This blog idea is empty.",
  "render-failed": "This blog idea could not be drawn. Download it to read it.",
};
