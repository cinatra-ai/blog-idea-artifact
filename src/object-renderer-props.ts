...
//
// DORMANT: these are the RELOCATED `@cinatra-ai/assets:blog-idea` object-type
...
// detail/preview/listRow, no `card`). This source houses the blog-idea object
...
/**
 * Minimal view-model of the `@cinatra-ai/assets:blog-idea` object — only the
